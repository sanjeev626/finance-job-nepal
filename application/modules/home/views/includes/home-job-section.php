...
<section class="fjn-job-tab-area section_15">
  <div class="container">
    <div class="row">
          ...
          <div class="client-content">
            <div class="tab-pane fade show active">
              <ul>
                ...
                ?>
                <li> <a href="<?php echo base_url().'clients'?>"> View More </a> </li>
              </ul>
            </div>
          </div>
        </div>
              ...
              <div class="col-md-12">
                <div class=" job-tab">
                  <ul class="nav nav-pills job-tab-switch" id="pills-tab" role="tablist">
                    <li class="nav-item"> <a class="nav-link active" id="pills-companies-tab" data-toggle="pill" href="#pills-recent" role="tab" aria-controls="pills-companies" aria-selected="true">Recent Jobs</a> </li>
                    <li class="nav-item"> <a class="nav-link" id="pills-fjn-tab" data-toggle="pill" href="#pills-fjn" role="tab" aria-controls="pills-fjn" aria-selected="false">Hot Jobs</a> </li>
                    <li class="nav-item"> <a class="nav-link" id="pills-newspaper-tab" data-toggle="pill" href="#pills-newspaper" role="tab" aria-controls="pills-newspaper" aria-selected="false">News PaperJobs</a> </li>
                  </ul>
                </div>
                      ...
                      <div class="col-md-4 col-sm-12 padding-left-right-0">
                        <div class="job-content">
                          <div class="top-company-list">
                            <h3> <a href="<?php echo $url?>" title="<?php echo $rj->jobtitle;?>" data-toggle="tooltip"> <?php echo substr($rj->jobtitle,0,28); ?> </a> </h3>
                            <div class="company-list-logo"> <a href="<?php echo $url?>">
                                <?php
                                ...
                                ?>
                              <img src="<?php echo base_url() . $img; ?>" alt="<?php echo $rj->jobtitle ?>"> </a> </div>
                            <div class="company-list-details">
                              <p> <i class="fa fa-building"></i> <a href="javascript:void(0)" data-toggle="tooltip" title="<?php echo $orgname?>"> <?php echo substr($orgname, 0, 20).''?> </a> </p>
                              <p class="company-state"> <i class="fa fa-map-marker"></i> <a href="javascript:void(0)" data-toggle="tooltip" title="<?php echo $empInfo->organization_address?>"> <?php echo substr($empInfo->organization_address, 0, 20).''?> </a> </p>
                      ...
                      <div class="col-md-12 col-sm-12 padding-left-right-0">
                        <div class="job-content">
                          <div class="company-name">
                            <div class="top-company-list">
                              <div class="job-title">
                                <h3> <a href="">No Jobs Available.</a> </h3>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    ?>
                      <div class="col-md-4 col-sm-12 padding-left-right-0">
                        <div class="job-content">
                          <div class="top-company-list">
                            <div class="job-title">
                              <h3> <a href="<?php echo $url?>" title="<?php echo $npj->jobtitle;?>" data-toggle="tooltip"> <?php echo substr($npj->jobtitle,0,28); ?> </a> </h3>
                            </div>
                            <div class="company-list-logo"> <a href="<?php echo $url?>">
                            <?php
                            if (!empty($empInfo->organization_logo)) {
                    ...
                    if($fjn_job) {
                      ...
                      <div class="col-md-4 col-sm-12 padding-left-right-0">
                        <div class="job-content">
                          <div class="top-company-list">
                            <div class="job-title">
                              <h3><a href="<?php echo $url?>" title="<?php echo $fjnj->jobtitle;?>" data-toggle="tooltip"> <?php echo substr($fjnj->jobtitle,0,28); ?></a></h3>
                            </div>
                            <div class="company-list-logo"> <a href="<?php echo $url?>/<?php echo $fjnj->id; ?>">
                            <?php
                            if (!empty($empInfo->organization_logo)) {
                                $img = 'uploads/employer/' . $empInfo->organization_logo;
                            } else {
                            ...
                            ?>
                              <img src="<?php echo base_url() . $img; ?>" alt="<?php echo $fjnj->jobtitle ?>"/> </a> </div>
                            <div class="company-list-details">
                              <p> <i class="fa fa-building"></i> <a href="javascript:void(0)" data-toggle="tooltip" title="<?php echo $orgname?>"> <?php echo substr($orgname, 0, 20).''?> </a> </p>
                              <p class="company-state"> <i class="fa fa-map-marker"></i> <a href="javascript:void(0)" data-toggle="tooltip" title="<?php echo $empInfo->organization_address?>"> <?php echo substr($empInfo->organization_address, 0, 20).''?> </a> </p>
                              <p class="open-icon"><i class="fa fa-clock-o"></i> <?php echo date("M d, Y", strtotime($fjnj->applybefore)) ?> </p>
                              <!-- <p class="varify"><i class="fa fa-check"></i>IT &amp; Telecommunication</p> --> 
                            </div>
                          </div>
                        </div>
      ...
      <div class="col-md-3">
        <div class="resumeupload"> <a href="#" data-toggle="modal" data-target="#cvModal"> <img src="<?php echo base_url(); ?>content_home/img/upload-your-resume.jpg"> </a> 
        ...
        <div class="homejobalert">
          ...
          ?>
          <a href="<?php echo $url?>"> <img src="<?php echo base_url(); ?>content_home/img/create-a-job-alert.jpg"> </a> </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> Apply With Your Basic Information <br>
          <span>We will get you back soon.</span> </h5>
