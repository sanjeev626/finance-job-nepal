...
<div class="col-md-3 login-sidebar">
    ...
    <div class="resume-status">            
        ...
        <ul>
            ...
            <li><a target="_blank" href="<?php echo base_url();?>Jobseeker/editProfile#education">Education Background</a> :<i class="fa <?php if($personal_detail > 0){ echo 'fa-check'; }else{ echo 'fa-times'; }?>" aria-hidden="true"></i></li>
           ...
           <div class="panel-body panel-body-nopadding">
        	...
        	?>
               <div class="form-group">
		            ...
		            <div class="col-sm-7">
		                <input type="text" required name="oldpassword" id='oldpassword' class="form-control" value='' />
		            </div>
		        </div>
