    ...
    <div class="joboverview">
        ...
        <div class="table-responsive">
            <table class="table">
                <tbody>
                    <?php
                        if(!empty($key_positions_all)){
                        foreach($key_positions_all as $key => $value):
                    ...
                    <tr class="<?php if($key % 2 ==0){ echo 'odd'; } ?>">
                        ...
                        <td>
                            <figcaption>
                                ...
                                <?php  } ?>                                
                            </figcaption><p><i class="fa fa-clock-o"></i><?php echo $applydays;?> Days remaining</p></td>
                        <td><a href="<?php echo base_url();?>applyJob/<?php echo $value->id;?>" class="btn btn-success">Apply Now</a><span><?php echo $jobType;?></span></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="3">No key position Vacancy Found !!!</td>
                    </tr>
                        <?php } ?>
