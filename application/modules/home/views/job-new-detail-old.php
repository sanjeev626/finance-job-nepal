...
<div class="container jobdetail-page">
    ...
    <div class="col-md-9 clearfix">
        ...
        <div class="vacancies-details">
            ...
            <p><strong>Preferred Gender :</strong> <?php echo $jobDetail->preferredgender;?></p>
            <p><strong>Job Level :</strong> <?php echo $jobDetail->joblevel;?></p>
            <?php $salary =  $this->general_model->getById('tbl_salaryranges','salaryrange_id',$jobDetail->salaryrange); ?>
            <p><strong>Salary :</strong>
                  <?php if($salary) echo $salary->title; ?>
                </p>
            <p><strong>Experience :</strong> <?php echo $jobDetail->noexperience; ?> year</p>
            <p><strong>Required Degree :</strong> <?php echo ($jobDetail->apply_by_faculty) ? $jobDetail->apply_by_faculty : 'Any'; ?> </p>
            <p><strong>Age Bar :</strong> <?php echo ($jobDetail->apply_by_age) ? $jobDetail->apply_by_age : 0; ?> year</p>
            <p><strong>No. of vacancy:</strong> <?php echo $jobDetail->requiredno; ?></p>
            <p style="color:#FF0000; font-weight:bold;"><strong>Apply Before:</strong> <?php echo date('d M Y',strtotime($jobDetail->applybefore));?></p>
          </div>
              <div class="elements">
