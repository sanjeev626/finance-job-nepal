...
<div class="row">
  <div class="col-md-12">
    ...
    <ul class="nav nav-tabs">      
      ...
      ?>
      <li class="col-md-4 menu <?php if($cnt==1) echo 'active';?>"><a data-toggle="tab" href="#menu<?php echo $cnt;?>" class="menu"><?php echo $value->dropvalue; ?></a></li>
      <?php
        }
      }
      ?>
    ...
    <div class="tab-content clearfix">            
      ...
      <div id="menu<?php echo $cnt;?>" class="tab-pane fade in <?php if($cnt==1) echo 'active';?>">
        ...
        <?php }else{?>
        <span>No <?php echo $value->dropvalue; ?> Job Found !!! </span>
        <?php } ?>
      </div>
      <?php
        }
    ...
    <ul class="nav nav-tabs">      
      ...
      foreach ($job_display_in as $key => $value) 
      {
        ...
        $display = $this->home_model->get_job_by_display_in($value->id,2);
      ?>
      <li class="col-md-4 menu <?php if($cnt==4) echo 'active';?>"><a data-toggle="tab" href="#menu<?php echo $cnt;?>" class="menu"><?php echo $value->dropvalue; ?></a></li>
      <?php
        }
      }
      ?>
    ...
    <div class="tab-content clearfix" style="margin-bottom: 0px;">            
      ...
      foreach ($job_display_in as $key => $value) 
      {
        ...
        $display = $this->home_model->get_job_by_display_in($value->id,9);
      ?>
      <div id="menu<?php echo $cnt;?>" class="tab-pane fade in <?php if($cnt==4) echo 'active';?>">
        <?php if(!empty($display)){ ?>
        <div class="row">
          <?php
          $cnt2=0;
