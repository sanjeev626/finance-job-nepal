                                ...
                                <div role="tabpanel" class="tab-pane active" id="My-Profile">
                                    <div class="personal-detail">
                                        <ul class="profile-width">
                                            <li><strong>Name
                                                    :</strong><?php echo $jobseekerInfo->fname . ' ' . $jobseekerInfo->mname . ' ' . $jobseekerInfo->lname; ?>
                                            </li>
                                            <li><strong>Address :</strong><?php echo $jobseekerInfo->address_current; ?>
                                            </li>
                                            <li><strong>Contact No.
                                                    :</strong><?php if (!empty($jobseekerInfo->phone_cell)) {
                                                    echo $jobseekerInfo->phone_cell; ?>(Mob),<?php }
                                                if (!empty($jobseekerInfo->phone_resisdance)) {
                                                    echo $jobseekerInfo->phone_resisdance; ?>(Res)
                                                <?php } ?></li>
                                            ...
                                            foreach ($seekerEmployment as $key => $sekVal): $key = $key + 1;
                                                ...
                                                <table class="table table-condensed">
                                                    ...
                                                    <tr>
                                                        <th>Duration</th>
                                                        <td>
                                                            From <?php echo date('M', strtotime($sekVal->frommonth)) . ' ' . $sekVal->fromyear; ?>
                                                            to
                                                            <?php
                                                            if ($current_work == 0) {
                                    ...
                                    <div class="educational-detail">
                                        ...
                                        <table class="table table-condensed">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if (!empty($jobseekerInfo->slc_docs)) { ?><a
                                                        href="<?php echo base_url() . "uploads/documents/" . $jobseekerInfo->slc_docs; ?>"
                                                        target="_blank">Download SLC documents</a><?php } ?>
                                                    <?php if (!empty($jobseekerInfo->docs_11_12)) { ?><br><a
                                                        href="<?php echo base_url() . "uploads/documents/" . $jobseekerInfo->docs_11_12; ?>"
                                                        target="_blank">Download 11/12 transcript</a><?php } ?>
                                                    <?php if (!empty($jobseekerInfo->bachelor_docs)) { ?><br><a
                                                        href="<?php echo base_url() . "uploads/documents/" . $jobseekerInfo->bachelor_docs; ?>"
                                                        target="_blank">Download Bachelors transcript</a><?php } ?>
                                                    <?php if (!empty($jobseekerInfo->masters_docs)) { ?><br><a
                                                        href="<?php echo base_url() . "uploads/documents/" . $jobseekerInfo->masters_docs; ?>"
                                                        target="_blank">Download Masters transcript</a><?php } ?>
                                                    <?php if (!empty($jobseekerInfo->other_docs)) { ?><br><a
                                                        href="<?php echo base_url() . "uploads/documents/" . $jobseekerInfo->other_docs; ?>"
                                                        target="_blank">Download other documents</a><?php } ?>
                                    ...
                                    <div class="personal-detail">
                                        ...
                                        <ul class="profile-width">
                                            ...
                                            <li><strong>Date of Birth
                                                    :</strong><?php echo $jobseekerInfo->dob?>
                                            </li>
                                            <li><strong>Nationality :</strong><?php //echo $nationality; ?></li>
                                            <li><strong>Gender :</strong><?php echo $jobseekerInfo->gender; ?></li>
                                            <li><strong>Phone (off) :</strong><?php echo $jobseekerInfo->phone_cell; ?>
                                            </li>
                                            <li><strong>Marital Status
                                                    :</strong><?php echo $jobseekerInfo->marital_status; ?></li>
                                            <li><strong>Permanent Address
                                                    :</strong><?php echo $jobseekerInfo->address_current; ?></li>
                                        </ul>
                                    </div>
                                    <!--  personal-detail -->
                                    ...
                                    <div class="personal-detail">
                                        ...
                                        <ul class="profile-width">
                                            ...
                                            ?>
                                            <li><strong>Have work experience
                                                    :</strong><?php echo $jobseekerInfo->experience_years; ?></li>
                                            <li><strong>Current Job posiiton
                                                    :</strong><?php echo $jobseekerInfo->cjobposiiton; ?></li>
                                            <li><strong>Key skills :</strong><?php echo $jobseekerInfo->keyskills; ?>
                                            </li>
                                            <!--<li><strong>Present Salary :</strong><?php /*echo $jobseekerInfo->presal; */?>
                                            </li>-->
                                            <!--<li><strong>Expected Salary :</strong><?php /*echo $exp_salary; */?></li>-->
                                            <!--<li><strong>Job Region
                                                    :</strong><?php /*echo ($jobseekerInfo->job_region > 0) ? $this->general_model->getById('dropdown', 'id', $jobseekerInfo->job_region)->dropvalue : '';*/ ?>
                                            </li>
                                            <li><strong>Preferred Job location
                                                    :</strong><?php /*echo $joblocation1 . ',' . $joblocation2; */?></li>-->
                                        </ul>
                                    </div>
                                    <!--  personal-detail -->
                                    ...
                                    if (!empty($jobseekerInfo->resume)) {
                                        ...
                                        ?>
                                        <a target="_blank" class="btn btn-success" href="<?php echo $resumepath; ?>">Download
                                            Resume </a>
                                        <?php
                                    }
                                    ?>
