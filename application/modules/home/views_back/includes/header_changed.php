          ...
          <div class="head_banner">
            <div id="globalad" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <ul>
                  ...
                  <li class="styled-select">
                    <select class="select small form-control" name="job_category">
                      ...
                      <?php foreach($job_organization as $key => $value){ ?>
              ...
              <?php /* ?><div class="carousel-inner" role="listbox">
                <div class="item active"> <a href="<?php echo base_url();?>upload_your_video_cv"><img src="<?php echo base_url();?>content_home/images/nepals_first_job_portal_to_introduce_video_cv.jpg" alt="head-banner" /></a> </div>
                <?php
                $where = array('type'=>'notice');
                ...
                if(!empty($sval->link))
                ?>
                <div class="item"> <a href="<?php echo $sval->link;?>">
        ...
        <div class="col-md-12">
          <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav">
              ...
              <li><a <?php if(!empty($video_cv) && $video_cv == 'benefits-of-video-cv'){ echo 'class="active"'; } ?> href="<?php echo $this->home_model->get_content_url('23');?>">Video CV <i class="fa fa-video-camera" aria-hidden="true"></i></a></li>
