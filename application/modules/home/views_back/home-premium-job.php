<section id="scrollbox5" class="hunting-job premium-hunting-job default-skin clearfix " tabindex="-1">
    ...
    <?php } 
    $no_of_premium_jobs = $this->home_model->count_job_by_type('isNewspaperJob','PJob');
    if($no_of_premium_jobs>5)
    {
    ?>
