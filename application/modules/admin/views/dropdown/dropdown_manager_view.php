            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel-footer">
                        <a class="btn btn-success" href="<?php echo base_url(); ?>admin/dropdown/add">
                            + Add Dropdown Value
                        </a>
                    </div>
                        ...
                        <table class="table table-striped mb30" id="table1" cellspacing="0" width="100%">
                            ...
                            if (!empty($dropdown)) {
                                foreach ($dropdown as $key):
                                    ...
                                    ?>
                                    <tr>
                                        <td><a href="javascript:void(0);" class="toggle_sku">
                                                <i rel="allfield" class="fa fa-plus-circle"></i>&nbsp;&nbsp;&nbsp;
                                                Field: <?php echo $key->title; ?>
                                            </a>
                                        </td>
                                    </tr>
                                                        ...
                                                        <tr class="success">
                                                            ...
                                                            <td class="table-action">
                                                                <a class="btn btn-success btn-sm"
                                                                   href="<?php echo base_url(); ?>admin/dropdown/edit/<?php echo $val->id; ?>"><i
                                                                        class="fa fa-edit tooltips"
                                                                        data-original-title="Edit Dropdown value"></i>
                                                                    Edit</a>
                                                                |
                                                                <button type="button"
                                                                        class="btn btn-success btn-sm delete_dropdown"
                                                                        link="<?php echo base_url(); ?>admin/dropdown/deletedropdown/<?php echo $val->id; ?>"
                                                                        data-toggle="modal"
                                                                        data-target="#myModalDelete"><i
                                                                        class="fa fa-trash tooltips"
                                                                        data-original-title="Delete Dropdown value"></i>
                                                                    Delete
                                                                </button>
                                                            </td>
                                                        </tr>
                                ...
                                <tr>
                                    <td colspan="8">
                                        <center>No Dropdown Field Found !!!</center>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
