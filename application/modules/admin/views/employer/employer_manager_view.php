                    ...
                    <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-action text-center">
                                            <a class="btn btn-success btn-sm"
                                               href="<?php echo base_url(); ?>admin/employer/view/<?php echo $key->id; ?>"><i
                                                    class="fa fa-eye tooltips" data-original-title="Edit Employer"></i>
                                                View</a>
                                            |
                                            <a class="btn btn-success btn-sm"
                                               href="<?php echo base_url(); ?>admin/employer/joblist/<?php echo $key->id; ?>"><i
                      ...
                      |-->
                                            <button type="button" class="btn btn-success btn-sm delete_employer"
                                                    link="<?php echo base_url(); ?>admin/employer/delete/<?php echo $key->id; ?>"
                                ...
                                <tr>
                                    <td colspan="8">
                                        <center>No Employer Found !!!</center>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
