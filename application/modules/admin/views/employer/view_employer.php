            ...
            <table class="table table-striped mb30" id="table1" cellspacing="0" width="100%" frame="box">
              ...
              <tbody>
                  ...
                  <tr>
                  	...
                  	<td><?php echo $employer_info->email2; ?></td>
                  	<td></td>
                  	<td></td>
                  </tr>
                  ...
                  <?php 
                    ...
                    $orga_head = $saluts." ". $employer_info->fname." ".$employer_info->mname." ".$employer_info->lname;
                  ...
                  <tr>
                  	<td class="green-bold">Logo Image :</td>
                  	<td><?php if(!empty($employer_info->logo)){?><img src="<?php echo the_employer_logo($employer_info->logo,'');?>" alt="Logo" style="width: 100px;"><?php } ?></td>
                  	<td></td>
                  	<td></td>
                  </tr>
                  ...
                  <tr>
                  	...
                  	<td><?php echo $employer_info->designation; ?></td>
                  	<td></td>
                  	<td></td>
                  </tr>
                  ...
                  <tr>
                  	...
                  	<td><?php echo $employer_info->address; ?></td>
                  	<td></td>
                  	<td></td>
                  </tr>
                  ...
                  <tr>
                  	...
                  	<td><?php echo $employer_info->phone; ?></td>
                  	<td></td>
                  	<td></td>
                  </tr>
                  ...
                  <tr>
                  	...
                  	<td><?php echo $employer_info->fax; ?></td>
                  	<td></td>
                  	<td></td>
                  </tr>
                  ...
                  <tr>
                  	...
                  	<td><?php echo $employer_info->pobox; ?></td>
                  	<td></td>
                  	<td></td>
                  </tr>
                  ...
                  <tr>
                  	...
                  	<td><?php echo $employer_info->website; ?></td>
                  	<td></td>
                  	<td></td>
                  </tr>
                  ...
                  <tr>
                  	...
                  	<td><?php echo $employer_info->contactperson; ?></td>
                  	<td></td>
                  	<td></td>
                  </tr>
                  ...
                  <tr>
                  	<td class="green-bold">Last Access :</td>
                  	<td><?php echo $employer_info->lastaccess; ?></td>
                  	<td class="green-bold">Membership Date</td>
                  	<td><?php echo $employer_info->joindate; ?></td>
                  </tr>
