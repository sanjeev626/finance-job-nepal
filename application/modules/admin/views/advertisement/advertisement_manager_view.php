            ...
            <table class="table table-striped mb30" id="table1" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                if (!empty($advertisement_info)) { 
                  foreach ($advertisement_info as $key):
                    ?>
                  <tr>
                    <td><?php echo $i; ?></td>
                    <td><?php echo $key->addtitle; ?></td>
                    <td><?php echo $key->website; ?></td>
                    <td><?php echo $key->addstatus; ?></td>
                  ...
                  ?>
                  <tr>
                    <td colspan="8"><center>No Advertisement Found !!!</center></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
...
<!-- Delete Modal -->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title green">Are you sure to Delete a Advertisement ?</h4>
        </div>
  ...
  <script type="text/javascript">
    $('document').ready(function(){
      $('.delete_advertisment').on('click',function(){ 
