<?php
    $action = base_url() . 'admin/Article/addArticle/';
?>
...
<div class="box box-info">
    ...
    <div class="panel-body panel-body-nopadding">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <textarea name="articles" class="form-control simple" id="description" ></textarea>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">&nbsp;</label>
            <div class="col-sm-8">
                <button class="btn btn-success btn-flat" type="submit">Add Article</button>&nbsp;
            </div>
        </div>
        <?php echo form_close(); ?>
    </div><!-- panel-body -->
