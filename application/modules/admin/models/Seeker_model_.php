...
class Seeker_model extends CI_Model {
    ...
    public function search_seeker_by_param($limit='',$offset=''){
      ...
      if(!empty($this->input->post('salutation')))
      {
      ...
      if(!empty($this->input->post('funcarea')))
      {
      ...
      if(!empty($this->input->post('appliedposition')))
      {
      ...
      if(!empty($this->input->post('keyskills')))
      {
      ...
      if(!empty($this->input->post('cjobposition')))
      {
      ...
      if(!empty($this->input->post('joblocation')))
      {
      ...
      if(!empty($this->input->post('expyrs')))
      {
      ...
      if(!empty($this->input->post('expyrs2')))
      {
      ...
      if(!empty($this->input->post('expsal')))
      {
      ...
      if(!empty($this->input->post('apporg')))
      {
      ...
      if(!empty($this->input->post('registerdate')))
      {
